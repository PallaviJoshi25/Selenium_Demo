...
public class WebOrder_Login_DataDrivenTest_Using_Excel extends WebOrder_TestData { //inheritance
	 WebDriver driver;
  @Test	(dataProvider = "LoginExcelData",priority = 1)	//annotation (for executing without main function) with priority 
