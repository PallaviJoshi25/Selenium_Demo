...
public class WebOrder_CreateOrder_All_TCs_Using_Switch extends WebOrder_TestData  {
	WebDriver driver;
	...
	public void pre_condition() {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5)); //Dynamic Time
